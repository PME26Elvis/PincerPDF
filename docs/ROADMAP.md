...
- Form collision handling, Unicode footer/contents fonts, collision-aware footer placement, normalization/compression and full legacy parity remain later P4 work.
