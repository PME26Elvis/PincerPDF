...
- **P4.8 — Filename table of contents: Partial.** An explicit UI/DTO policy prepends a generated contents page (with pagination for larger source lists) and keeps document bookmarks pointed at the shifted source pages; filename-mode contract evidence is green.
